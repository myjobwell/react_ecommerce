...
function ModalSuccess({ text }) {
    return (
        ...
        <div
            ...
            z-[1000] before:fixed before:inset-0 before:w-full before:h-full
            before:bg-[rgba(0,0,0,0.5)] overflow-auto font-[sans-serif]">
            <div className="w-full max-w-lg bg-white shadow-lg rounded-lg p-6 relative">
                <svg xmlns="http://www.w3.org/2000/svg"
                     className="w-3.5 cursor-pointer shrink-0
                     fill-gray-400 hover:fill-red-500 float-right"
                ...
                <div className="my-8 text-center">
                    ...
                    <p className="text-sm text-gray-500 leading-relaxed mt-4">{text}</p>
                </div>
            </div>
        </div>
